...
const (
	Book_GetBook_FullMethodName = "/api.helloworld.v1.Book/GetBook"
)
...
type BookClient interface {
	GetBook(ctx context.Context, in *GetBooksRequest, opts ...grpc.CallOption) (*GetBooksReply, error)
}
...
func (c *bookClient) GetBook(ctx context.Context, in *GetBooksRequest, opts ...grpc.CallOption) (*GetBooksReply, error) {
...
func (UnimplementedBookServer) GetBook(context.Context, *GetBooksRequest) (*GetBooksReply, error) {
